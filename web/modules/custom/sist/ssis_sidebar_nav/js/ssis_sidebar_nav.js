 ...
 */
 ...
 (function ($, Drupal) {
    ...
    $(document).ready(function(){
        ...
        if ($(window).width() <= 768) {
            // Get and wrap the content from the sidebar nav p
            var content = $('p#block-mainnavigation-menu').html();
            ...
            // Reinsert the content into the sidebar nav p
            $('p#block-mainnavigation-menu').html( content );
        ...
        if ($(window).width() >= 769) {
            ...
            $("p#block-mainnavigation-menu").find("a.sidebarnavtitlelink").contents().unwrap();
        ...
        $(window).on('resize', function () {
          ...
          if ($(window).width() <= 768) {
              ...
              // Reinsert the content into the sidebar nav p only if it hasn't been placed already
